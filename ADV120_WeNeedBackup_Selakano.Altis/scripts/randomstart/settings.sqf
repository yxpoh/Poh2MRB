...
_markerArrayEast = ["redstart_1","redstart_2","redstart_3"];
_objectArrayEast = [opforVeh_1,opforVeh_2,opforVeh_3,opforVeh_4,opforVeh_5,opforVeh_6]; // If empty make equal to []
